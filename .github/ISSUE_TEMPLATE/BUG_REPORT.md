---
name: Bug report
about: Create a report to help us improve node-mime-types
title: ''
labels: ''
assignees: ''
...
* [ ] I have searched the [issue tracker](https://github.com/elysiumphase/node-mime-types/issues) for an issue that matches the one I want to file, without success.
...
* **Node Version**:
* **NPM Version**:
* **node-mime-types Version**:
* **Last Known Working node-mime-types Version**:
